...
def do_state_display():
    ...
    draw.text((x+32, top+16), str(readings['tankLevel'].), font=font, fill=255)
    draw.text((x+32, top+32), str(readings['tankTemp'].), font=font, fill=255)      
    draw.text((x+32, top+48), str(readings['bedTemp'].), font=font, fill=255)
